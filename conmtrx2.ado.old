*! October 5, 2017: Modified to suppress second tabulation.
*! October 5, 2017: Modified to report incorrect classification.
*! Revised by: Adam Ross Nelson
*! Maintained at: https://github.com/adamrossnelson/conmtrx
*! Original version: 
*! version 1.0.1 Ariel Linden 13jan2016
*! 1.0.0 Ariel Linden 27dec2015 
*! Documented at: https://ideas.repec.org/c/boc/bocode/s458127.html

capture program drop conmtrx2
program define conmtrx2, rclass
	version 11.0
	...
	quietly {
		...
		* Classification calculations
		...
		ret scalar P_inco = ((`2'+`3')/(`1'+`2'+`3'+`4'))*100 							/* overall incorrectly classified */
	...
	di    in gr `"Incorrectly classified"' _col(27) `"B+D/(A+B+C+D)"'
              in ye %8.2f return(P_inco) `"%"' _col(55) ;
    di    in smcl in gr "{hline 49}"  ;
